...
If SmartTags("con_state_PLC1") >= 11 Then
	If SmartTags("connected_to") = "Connected with PLC 1" Then
		ChangeConnection "Connection12", "192.164.0.102", 1, 1
		SmartTags("con_state_PLC1") = 100
		SmartTags("connected_to") = "Connected with PLC 2"
	ElseIf SmartTags("connected_to") = "Connected with PLC 2" Then
		SmartTags("con_state_PLC1") = 100
	End If
End If
...
If SmartTags("connected_to") = "connection lost" Then
	ChangeConnection "Connection12", "192.168.0.102", 1, 1
	SmartTags("con_state_PLC1") = 100
	SmartTags("connected_to") = "Connected with PLC 2"
End If
